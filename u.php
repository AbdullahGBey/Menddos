...
<html>
  <head>
    ...
    <title>Ninja-Stress | Stresser</title>
...
<a class="navbar-item " href="vip.php">
				<span class="icon">
				  <i class="fas fa-rocket" aria-hidden="true"></i>
				</span> 
				<span>Attack [VIP]</span>
			</a>

						
			<a class="navbar-item " href="store.php">
				<span class="icon">
			...
			<a class="navbar-item " href="api.php">
				<span class="icon">
				  <i class="fas fa-link" aria-hidden="true"></i>
				</span> 
				<span>API</span>
			</a>
			<a class="navbar-item " href="https://discord.gg/Akv6jbq">
				<span class="icon">
...
<a class="navbar-item " href="th3fuck3r/admin/">
				<span class="icon">
			...
			<div class="navbar-item has-dropdown is-hoverable">
				...
				<div class="navbar-dropdown">
				  <div class="navbar-item">
					Plan: <?php echo htmlspecialchars($rowxd['name']); ?>				  </div>	
				  <div class="navbar-item">
					 Seconds: <?php echo $rowxd['mbt']; ?>				  </div>
				  <div class="navbar-item">
					 Expire Plan : <?php echo $date; ?>			  </div>
				  <div class="navbar-item">
					Concurent : <?php echo $rowxd['concurrents']; ?>				  </div>	
				  			</div>
